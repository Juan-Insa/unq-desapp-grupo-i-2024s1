...
class InvalidCBUException(msg: String = "The CVU must be 22 digits in length"): IllegalArgumentException(msg) {  }
class InvalidCryptoWalletAdressException(msg: String = "The wallet adress must be 8 digits in length"): IllegalArgumentException(msg) {  }